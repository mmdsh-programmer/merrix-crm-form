...
function loadCity(province) {
    ...
    switch (province) {
        ...
        case "کهگیلویه و بویراحمد":
            ...
            break;
        case "گلستان":
            var selectValues = { "آزادشهر": "آزادشهر", "آق ‌قلا": "آق‌ قلا", "بندر گز": "بندر گز", "ترکمن": "ترکمن", "رامیان": "رامیان", "علی آباد کتول": "علی آباد کتول", "کرد کوی": "کرد کوی", "کلاله": "کلاله", "گالیکش": "گالیکش", "گرگان": "گرگان", "گمیشان": "گمیشان", "گنبد کاووس": "گنبد کاووس", "مراوه ‌تپه": "مراوه‌ تپه", "مینودشت": "مینودشت" };
            break;
        case "گیلان":
        ...
        case "لرستان":
            ...
            break;
        case "مازندران":
            var selectValues = { "آمل": "آمل", "بابل": "بابل", "بابلسر": "بابلسر", "بهشهر": "بهشهر", "تنکابن": "تنکابن", "جویبار": "جویبار", "چالوس": "چالوس", "رامسر": "رامسر", "ساری": "ساری", "سوادکوه": "سوادکوه", "سوادکوه شمالی": "سوادکوه شمالی", "سیمرغ": "سیمرغ", "عباس آباد": "عباس آباد", "فریدون کنار": "فریدون کنار", "قائم ‌شهر": "قائم ‌شهر", "گلوگاه": "گلوگاه", "محمود آباد": "محمود آباد", "نکا": "نکا", "نور": "نور", "نوشهر": "نوشهر", "فرح آباد": "فرح آباد" };
            break;
        case "مرکزی":
